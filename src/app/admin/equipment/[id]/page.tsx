...
export default async function AdminEquipmentDetailsPage({
  params,
}: {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 bg-white dark:bg-zinc-900 shadow-sm">
        ...
        <div className="pt-6 mt-6 border-t border-zinc-100 dark:border-zinc-800 flex flex-col gap-3">
            <p className="text-[11px] text-zinc-500 uppercase tracking-wider font-semibold">Total in stock</p>
            
            {/* 2. Pass the ID and current stock state to the Client Component */}
            <UpdateStock 
